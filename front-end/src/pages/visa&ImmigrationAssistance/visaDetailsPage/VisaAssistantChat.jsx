...
import {
  getPreviousChat,
  getResponseFromChatBoat,
} from "@/apiService.js/visa.service";
import { Spinner } from "@/components/custom";

function VisaAssistantChat() {
  ...
  const handleSendMessage = async (e) => {
    ...
    const response = await getResponseFromChatBoat({
  ...
  useEffect(() => {
    ...
    const fetchUserPreviousMessage = async () => {
      const response = await getPreviousChat();
...
export default VisaAssistantChat;
