      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6">
          ...
          <p className="text-gray-600 text-lg">
            Landlords, letting agents, and private hall managers – advertise
            your property in minutes and reach thousands of students daily. Get
            unparalleled exposure and attract the ideal tenants for your spaces!
          </p>

          <Link to={"/find-accommodations/new-accommodation"}>
            <button
              className="inline-flex items-center px-6 py-3 rounded-full border-2 border-gray-900 
        ...
        <div className="relative">
          <div
            className="absolute top-0 right-0 w-48 h-48 bg-purple-100 rounded-full -z-10 
            blur-2xl opacity-60"
          ></div>
          <div
            className="absolute bottom-0 left-0 w-48 h-48 bg-purple-100 rounded-full -z-10 
            blur-2xl opacity-60"
          ></div>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden max-w-md mx-auto">
            <div className="relative">
              ...
              <div
                className="absolute top-4 left-4 bg-emerald-500 text-white px-4 py-1 
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div
                    className="w-10 h-10 bg-orange-500 rounded-lg flex items-center 
